...
```{r, engine='bash', eval=FALSE}
export PATH=${PATH}:/dexter/disk2/smart/programs/cmake-2.8.12.2
```
...
```{r, engine='bash', eval=FALSE}
export PATH=${PATH}:/dexter/disk2/smart/programs/ANTs.2.1.0.Debian-Ubuntu_X64
```
...
```{r, engine='bash', eval=FALSE}
export PATH=${PATH}::/dexter/disk2/smart/programs/dcm2niix/console/ 
```
...
```{r, engine='bash', eval=FALSE}
export FREESURFER_HOME=/dexter/disk2/smart/programs/freesurfer
